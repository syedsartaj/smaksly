      ...
      <div className="flex-1 flex flex-col overflow-y-auto bg-[#1f1d1d]">
        ...
        <main className="max-w-xl mx-auto p-6 space-y-4">
          ...
          <input
            ...
            className="w-full p-2 border-[0.001px] text-white rounded bg-[#403f3f]"
          ...
          <input
            ...
            className="w-full p-2 border-[0.001px] rounded bg-[#403f3f]"
            placeholder="Optional custom domain (e.g. mydomain.com)"
          />
        <button
        onClick={handleDeploy}
        className="bg-[#403f3f] border-[0.001px] text-white px-4 py-2 rounded hover:bg-gradient-to-b hover:from-[#1A1B1E] hover:to-[#141517] active:bg-gradient-to-b active:from-[#1A1B1E] active:to-[#141517] transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-600"
        >
