...
function AddAccountModal({
  ...
  const [form, setForm] = useState({
    ...
    email: '',
    displayName: '',
    imapHost: EMAIL_PRESETS.zoho.imapHost as string,
    imapPort: EMAIL_PRESETS.zoho.imapPort as string,
    smtpHost: EMAIL_PRESETS.zoho.smtpHost as string,
    smtpPort: EMAIL_PRESETS.zoho.smtpPort as string,
    username: '',
    password: '',
    smtpUsername: '',
    smtpPassword: '',
